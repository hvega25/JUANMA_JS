...
function convertir_numeros() {
  ...
  while (control == false) {
    // primero ciclo que controla la salida del programa

    while (original % 10 != 0) {
      // ciclo que controla si el numero es de base 10
    ...
    console.log(
      ` El número original es: ${original}, el número en binario: ${bin_conv}, el número en hexadecimal es: ${hexadec}, el número en octal es: ${oct_cn}`
    );
...
function pruebas() {
  let original = parseInt(prompt("Ingresa"));
